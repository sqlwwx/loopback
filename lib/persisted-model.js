...
module.exports = function(registry) {
  ...
  PersistedModel.setupRemoting = function() {
    ...
    if (options.updateOnPUT) {
      ...
      configurableVerbs.updateAttributes = 'put';
      configurableVerbs.updateOrCreate = 'put';
    }
    ...
    setRemoting(PersistedModel, 'upsert', {
      ...
      accepts: { arg: 'data', type: 'object', http: { source: 'body' }, description:
        'Model instance data' },
      returns: { arg: 'data', type: typeName, root: true },
      http: { verb: configurableVerbs.updateOrCreate, path: '/' },
    });
    ...
    setRemoting(PersistedModel, 'replaceOrCreate', {
      ...
      accepts: { arg: 'data', type: 'object', http: { source: 'body' }, description:
        'Model instance data' },
      returns: { arg: 'data', type: typeName, root: true },
      http: { verb: configurableVerbs.replaceOrCreate, path: '/' },
    });
    ...
    setRemoting(PersistedModel, 'replaceById', {
      ...
      returns: { arg: 'data', type: typeName, root: true },
      http: { verb: configurableVerbs.replaceById, path: '/:id' },
      rest: { after: convertNullToNotFoundError },
    });
    ...
    setRemoting(PersistedModel.prototype, 'updateAttributes', {
      ...
      returns: { arg: 'data', type: typeName, root: true },
      http: { verb: configurableVerbs.updateAttributes, path: '/' },
    });
