...
var deprecated = require('depd')('loopbacknext');
...
module.exports = function(registry) {
  ...
  PersistedModel.setupRemoting = function() {
    ...
    setRemoting(PersistedModel.prototype, 'updateAttributes', {
      ...
      accessType: 'WRITE',
      accepts: [
        {arg: 'data', type: 'object', http: {source: 'body'}, description: 'An object of model property name/value pairs'},
        {arg: 'options', type: 'object', http: {source: 'query'}, description: '{fromServer}'},
      ],
      returns: {arg: 'data', type: typeName, root: true},
      http: {verb: 'put', path: '/'}
    });
