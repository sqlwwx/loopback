...
var SharedClass = require('strong-remotingnext').SharedClass;
var extend = require('util')._extend;
var ValidationError = require('loopback-datasource-jugglernext').ValidationError;
  ...
  Model.hasManyRemoting = function(relationName, relation, define) {
    ...
    if (relation.modelThrough || relation.type === 'referencesMany') {
      ...
      define('__unlink__' + relationName, {
        ...
        accepts: [
          {arg: 'fk', type: 'any', description: 'Foreign key for ' + relationName, required: true, http: {source: 'path'}},
          {arg: 'filter', type: 'object', http: {source: 'query'}, description: '{}'}
        ],
